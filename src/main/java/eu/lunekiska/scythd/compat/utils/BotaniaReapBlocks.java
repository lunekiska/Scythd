...
public class BotaniaReapBlocks extends HoeItem implements IManaUsingItem, ISortableTool
{
    private static final int MANA_PER_DAMAGE = 60;

    public BotaniaReapBlocks(Properties props, int attackDamage)
    {
        this(BotaniaAPI.instance().getManasteelItemTier(), attackDamage, props, -1f);
    }

    public BotaniaReapBlocks(IItemTier mat, int attackDamage, Properties properties, float attackSpeed)
    {
