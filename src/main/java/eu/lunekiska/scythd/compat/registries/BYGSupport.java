...
public class BYGSupport
{
    ...
    public static final RegistryObject<ToolItem> PENDORITE_SCYTHE = BYG_SUP_ITEMS.register("pendorite_scythe", () -> new BYGScytheTool(BYGItemTiers.PENDORITE, 5/2, -1.5f, 4, true, new Item.Properties().group(Scythd.scythes).maxStackSize(1)));
