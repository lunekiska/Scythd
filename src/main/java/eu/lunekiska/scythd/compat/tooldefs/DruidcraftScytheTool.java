...
public class DruidcraftScytheTool extends HoeItem
{
    protected int harvestRadius;
    protected boolean circleHarvest;
    private int mineLevel = -1;

    public DruidcraftScytheTool(ToolMaterialRegistry material, int attackDamage, float attackSpeed, Properties properties)
    {
    ...
    public DruidcraftScytheTool(ToolMaterialRegistry material, int attackDamage, float attackSpeed, int harvestRadius, boolean circleHarvest, Properties properties)
    {
    ...
    private static int getRadius(ToolMaterialRegistry material)
    {
        return (int) (Math.floor(material.getHarvestLevel()/2.0) + 1);
    }

    private static boolean shouldBeCircle(ToolMaterialRegistry material)
    {
