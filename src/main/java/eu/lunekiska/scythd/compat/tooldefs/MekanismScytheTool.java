...
public class MekanismScytheTool extends HoeItem
{
    protected int harvestRadius;
    protected boolean circleHarvest;
    private int mineLevel = -1;

    public MekanismScytheTool(IItemTier material, int attackDamage, float attackSpeed, Properties properties)
    {
    ...
    public MekanismScytheTool(IItemTier material, int attackDamage, float attackSpeed, int harvestRadius, boolean circleHarvest, Properties properties)
    {
