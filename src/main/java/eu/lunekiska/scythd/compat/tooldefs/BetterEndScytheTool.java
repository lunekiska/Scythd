...
public class BetterEndScytheTool extends HoeItem
{
    protected int harvestRadius;
    protected boolean circleHarvest;
    private int mineLevel = -1;

    public BetterEndScytheTool(IItemTier material, int attackDamage, float attackSpeed, Properties properties)
    {
    ...
    public BetterEndScytheTool(IItemTier material, int attackDamage, float attackSpeed, int harvestRadius, boolean circleHarvest, Properties properties)
    {
