...
public class AquacultureScytheTool extends HoeItem
{
    protected int harvestRadius;
    protected boolean circleHarvest;
    private int mineLevel = -1;

    public AquacultureScytheTool(IItemTier material, int attackDamage, float attackSpeed, Properties properties)
    {
    ...
    public AquacultureScytheTool(IItemTier material, int attackDamage, float attackSpeed, int harvestRadius, boolean circleHarvest, Properties properties)
    {
