...
public class BYGScytheTool extends HoeItem
{
    protected int harvestRadius;
    protected boolean circleHarvest;
    private int mineLevel = -1;

    public BYGScytheTool(BYGItemTiers material, int attackDamage, float attackSpeed, Properties properties)
    {
    ...
    public BYGScytheTool(BYGItemTiers material, int attackDamage, float attackSpeed, int harvestRadius, boolean circleHarvest, Properties properties)
    {
    ...
    private static int getRadius(BYGItemTiers material)
    {
        return (int) (Math.floor(material.getHarvestLevel()/2.0) + 1);
    }

    private static boolean shouldBeCircle(BYGItemTiers material)
    {
