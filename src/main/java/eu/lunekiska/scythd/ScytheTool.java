...
public class ScytheTool extends HoeItem
{
    ...
    public ScytheTool(ItemTier material, int attackDamage, float attackSpeed, Properties properties)
    {
    ...
    public ScytheTool(ItemTier material, int attackDamage, float attackSpeed, int harvestRadius, boolean circleHarvest, Properties properties)
    {
    ...
    private static int getRadius(ItemTier material)
    {
        return (int) (Math.floor(material.getHarvestLevel()/2.0) + 1);
    }

    private static boolean shouldBeCircle(ItemTier material)
    {
